     ...
     <Carousel>
      <CarouselContent> 
        ...
        <button onClick={imageBtn} className='absolute left-[47%] top-[40%] transition-all hover:scale-[150%] z-20' ><Image src={play_icon} alt='play-icon'/></button>
          <Image loading="eager" src={chavika_image} alt='chavika Image' className='absolute rounded-3xl ' />
          </div>
        ...
        <CarouselItem className='relative'>
        <div style={{display:image}} >
        <button onClick={imageBtn} className='absolute left-[47%] top-[40%] transition-all hover:scale-[150%] z-20'><Image loading="eager" src={play_icon} alt='play-icon'/></button>
          <Image loading="eager" src={nandin_image} alt='nandini Image' className='absolute'   />
          </div>
