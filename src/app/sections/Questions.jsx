  ...
  return (
    ...
    <div className='doubt-sec py-10'>
     <div className='mx-[30px] lg:mx-[90px]'>
      ...
      <button className='bg-red-600 text-white px-5 py-3 flex  justify-center items-center rounded-2xl'><Image src={phone_icon} alt="" /><a href="tel:+917416939333"><strong>+91 741-693-9333</strong></a></button>
