      ...
      <Carousel className='py-5' plugins={[
       ...
       <CarouselContent>
        <CarouselItem className="lg:basis-1/3 ">
            <Image src={front_end_image} alt='front end image' className='carousel-img rounded-3xl'/>
        </CarouselItem>
        <CarouselItem className="lg:basis-1/3 ">
            <Image src={front_end_image} alt='front end image' className='carousel-img  rounded-3xl'/>
        </CarouselItem>
        <CarouselItem className="lg:/3 basis-1">
            <Image src={designing_image} alt='front end image' className='carousel-img  rounded-3xl'/>
        </CarouselItem>
        <CarouselItem className="lg:basis-1/3 ">
            <Image src={digital_marketing} alt='front end image' className='carousel-img  rounded-3xl'/>
        </CarouselItem>
       </CarouselContent >
